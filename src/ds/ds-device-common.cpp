...
namespace librealsense
{
    ...
    {
        optic_serial = _hw_monitor->get_module_serial_string(gvd_buff, d400_gvd::d400_gvd_offsets::module_serial_offset);
        asic_serial = _hw_monitor->get_module_serial_string(gvd_buff, d400_gvd::d400_gvd_offsets::module_asic_serial_offset);
        fwv = _hw_monitor->get_firmware_version_string<uint8_t>(gvd_buff, d400_gvd::d400_gvd_offsets::camera_fw_version_offset);
    }
