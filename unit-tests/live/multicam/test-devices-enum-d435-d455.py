...
# Test configuration: Enumerate D435 and D455 devices only
#test:multi_device D455 D435

"""
Device enumeration test specifically for D435 and D455 devices.

This test enumerates and verifies D435 and D455 devices as configured by the test infrastructure.
The #test:device directives ensure the test only runs when D435 or D455 devices are available.
The test code filters to only process D435 and D455 devices from all connected devices.
"""
